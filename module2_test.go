...
func TestMutexIsIntializedModule2(t *testing.T) {
	alog := New(nil)
	if alog.m == nil {
...
func TestWriteSendsWriteRequestsSequentiallyWhenPanickingModule2(t *testing.T) {
...
func TestWriteSendsErrorsAsynchronouslyModule2(t *testing.T) {
	TestWriteSendsWriteRequestsSequentiallyWhenPanickingModule2(t)
	b := bytes.NewBuffer([]byte{})
